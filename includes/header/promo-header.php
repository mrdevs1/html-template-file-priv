...
/* Header file codes here
Included - promo-offers.php
...
<head>
    ...
    <!--title-->
    <title>Get Exclusive Promo Offer - Kloudwes</title>
    ...
    <!-- Meta Pixel Code -->
        ...
        fbq('init', '669888731719730');
        fbq('track', 'PageView');
        </script>
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=669888731719730&ev=PageView&noscript=1"
        /></noscript>
    <!-- End Meta Pixel Code -->
    
    <!-- FB Business Manager Domain Verification -->
        <meta name="facebook-domain-verification" content="7rjy70kxwdf8zw0r4jpe2hqava73po" />
    <!-- FB Business Manager Domain Verification End -->
...
<body>
    ...
    <div id="preloader">
        <div class="preloader-wrap">
            <img src="assets/img/kloudwebs-preloader.png" alt="kloudwebs preloader" class="img-fluid" />
            <div class="preloader">
                <i>.</i>
                <i>.</i>
                <i>.</i>
        ...
        <div id="logoAndNav" class="main-header-menu-wrap bg-transparent fixed-top">
            <div class="container">
                <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                    ...
                    <!--logo start-->
                    <a class="navbar-brand" href="index.html"><img src="assets/img/kloudwebs-logo.png" width="150" alt="kloudwebs logo" class="img-fluid" /></a>
                    <!--logo end-->
                    ...
                    <div id="navBar" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto main-navbar-nav">
                            ...
                            <li class="nav-item hs-has-mega-menuBLOCKED custom-nav-item" data-position="center">
                                <a id="homeMegaMenu" class="nav-link custom-nav-link main-link-toggleBLOCKED" href="index.html" aria-haspopup="true" aria-expanded="false">Home</a>
                                ...
                                <ul id="pagesSubMenu" class="hs-sub-menu main-sub-menu" aria-labelledby="pagesMegaMenu" style="min-width: 230px;">
                                    ...
                                    <li class="hs-has-sub-menu">
                                        ...
                                        <ul id="navSubmenuPagesPricing" class="hs-sub-menu main-sub-menu" aria-labelledby="navLinkPagesPricing" style="min-width: 230px;">
                                            ...
                                            <li><a class="nav-link sub-menu-nav-link" href="pricing-web-hosting.html">Web Hosting Packages</a></li>
                                            <li><a class="nav-link sub-menu-nav-link" href="pricing-windows-hosting.html">Windows Hosting</a></li>
                                    ...
                                    <li class="hs-has-sub-menu">
                                        ...
                                        <ul id="navSubmenuPagesLogin" class="hs-sub-menu main-sub-menu" aria-labelledby="navLinkPagesLogin" style="min-width: 230px;">
                                            ...
                                            <li><a class="nav-link sub-menu-nav-link" href="password-reset.html">Recover Account</a></li>
                                        </ul>
                                    </li>
                                </ul>
                                <!-- End Pages - Submenu -->
                            ...
                            <!--hosting start-->
                            <li class="nav-item hs-has-mega-menuBLOCKED custom-nav-item position-relative" data-position="center">
                                <a id="hostingMegaMenu" class="nav-link custom-nav-link main-link-toggleBLOCKED" href="web-hosting.html" aria-haspopup="true" aria-expanded="false">Hosting</a>
                            ...
                            <li class="nav-item header-nav-last-item d-flex align-items-center">
                                <a class="btn btn-brand-03 animated-btn" href="https://clients.kloudwebs.com/index.php/login" target="_blank">
