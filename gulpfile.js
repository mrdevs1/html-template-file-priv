    ...
    return src('build/*.html')
        .pipe(htmlreplace({
            'js': [
                ...
                'assets/js/vendors/countdown.min.js',
                'assets/js/vendors/jquery.waypoints.min.js',
                'assets/js/vendors/jquery.rcounterup.js',
                'assets/js/vendors/magnific-popup.min.js',
