...
<head>
    ...
    <!--favicon icon-->
    <link rel="icon" href="assets/img/kloudwebs-favicon.png" type="image/png" sizes="16x16">

    <!--title-->
    <title>Domain Search - Kloudwebs</title>
...
<body>
    ...
    <div id="preloader">
        <div class="preloader-wrap">
            <img src="assets/img/kloudwebs-preloader.png" alt="kloudwebs logo" class="img-fluid"/>
            <div class="preloader">
                <i>.</i>
                <i>.</i>
                <i>.</i>
        ...
        <div id="logoAndNav" class="main-header-menu-wrap bg-transparent fixed-top">
            <div class="container">
                <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                    ...
                    <!--logo start-->
                    <a class="navbar-brand" href="index.html"><img src="assets/img/kloudwebs-logo.png" width="120" alt="kloudwebs logo"
                                                                   class="img-fluid"/></a>
                    <!--logo end-->
                    ...
                    <div id="navBar" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto main-navbar-nav">
                            <!--home start-->
                            <li class="nav-item hs-has-mega-menuBLOCKED custom-nav-item" data-position="center">
                                <a id="homeMegaMenu" class="nav-link custom-nav-link main-link-toggleBLOCKED"
                                   href="index.html" aria-haspopup="true" aria-expanded="false">Home</a>
                                        ...
                                        <div class="col-lg-7 col-sm-6 col-12 custom-radius-right">
                                            <div class="row no-gutters p-4">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="title-with-icon-item">
                                                        <a class="title-with-icon-link" href="#">
                                                            <img src="assets/img/client-6-color.png" width="85" class="img-fluid" alt="client"/>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="title-with-icon-item">
                                                        <a class="title-with-icon-link" href="#">
                                                            <img src="assets/img/client-4-color.png" width="85" class="img-fluid" alt="client"/>
                                                            <small class="u-header__promo-text">Corporate Business Template</small>
                                                        </a>
                                                    </div>
                                                    <div class="title-with-icon-item">
                                                        <a class="title-with-icon-link" href="#">
                                                            <img src="assets/img/client-5-color.png" width="85" class="img-fluid" alt="client"/>
                            ...
                            <!--pages start-->
                            <li class="nav-item hs-has-sub-menuBLOCKED custom-nav-item">
                                <a id="pagesMegaMenu" class="nav-link custom-nav-link main-link-toggle"
                                   href="javascript:void(0);" aria-haspopup="true" aria-expanded="false"
                                   aria-labelledby="pagesSubMenu">Services</a>
                                ...
                                <ul id="pagesSubMenu" class="hs-sub-menu main-sub-menu" aria-labelledby="pagesMegaMenu"
                                    ...
                                    <li class="nav-item submenu-item">
                                        <a class="nav-link sub-menu-nav-link" href="black-friday-coming.html">Black Friday Coming<span class="badge badge-warning ml-auto">New</span></a>
                                    </li>
                                    <li class="nav-item submenu-item">
                                    ...
                                    <li class="nav-item submenu-item">
                                        <a class="nav-link sub-menu-nav-link" href="terms-condition.html">Terms & Condition<span class="badge badge-warning ml-auto">New</span></a>
                                    </li>
                                    <li class="nav-item submenu-item">
                                        <a class="nav-link sub-menu-nav-link" href="privacy-policy.html">Privacy Policy<span class="badge badge-warning ml-auto">New</span></a>
                                    </li>
                                    <li class="hs-has-sub-menu">
                                        ...
                                        <ul id="navSubmenuPagesPricing" class="hs-sub-menu main-sub-menu"
                                            ...
                                            <li><a class="nav-link sub-menu-nav-link"
                                                   href="pricing-web-hosting.html">Web Hosting Packages</a></li>
                                            <li><a class="nav-link sub-menu-nav-link"
                                                   href="pricing-windows-hosting.html">Windows Hosting</a></li>
                                            <li><a class="nav-link sub-menu-nav-link"
                                    ...
                                    <li class="hs-has-sub-menu">
                                        ...
                                        <ul id="navSubmenuPagesSpecialty" class="hs-sub-menu main-sub-menu"
                                            ...
                                            <li><a class="nav-link sub-menu-nav-link"
                                                   href="domain-search-result.html">Search Search Result <span class="badge badge-warning ml-2">New</span></a></li>
                                            <li><a class="nav-link sub-menu-nav-link"
                                                   href="cover-page.html">Cover Page</a></li>
                                            <li><a class="nav-link sub-menu-nav-link"
                                                   href="coming-soon.html">Coming Soon</a></li>
                                            <li><a class="nav-link sub-menu-nav-link"
                                                   href="thank-you.html">Thank You</a></li>
                                            <li><a class="nav-link sub-menu-nav-link"
                                    ...
                                    <li class="hs-has-sub-menu">
                                        ...
                                        <ul id="navSubmenuPagesLogin" class="hs-sub-menu main-sub-menu"
                                            ...
                                            <li><a class="nav-link sub-menu-nav-link"
                                                   href="password-reset.html">Recover Account</a></li>
                                        </ul>
                                    </li>
                                </ul>
                                <!-- End Pages - Submenu -->
                            ...
                            <!--hosting start-->
                            <li class="nav-item hs-has-mega-menuBLOCKED custom-nav-item position-relative"
                                data-position="center">
                                <a id="hostingMegaMenu" class="nav-link custom-nav-link main-link-toggleBLOCKED"
                                   href="shared-hosting" aria-haspopup="true" aria-expanded="false">Hosting</a>
                                ...
                                <div class="hs-mega-menu main-sub-menu" style="width: 715px" aria-labelledby="hostingMegaMenu">
                                    ...
                                    <div class="u-header__product-banner bg-image" image-overlay="8">
                                        ...
                                        <div class="u-header__product-banner-content position-relative z-index text-center text-white">
                                            ...
                                            <a class="btn btn-brand-03"
                                               href="#">Get Started<span class="ti-arrow-right pl-2"></span></a>
                                        </div>
                                    </div>
                            ...
                            <li class="nav-item header-nav-last-item d-flex align-items-center">
                                <a class="btn btn-brand-03 animated-btn" href="https://clients.kloudwebs.com/" target="_blank">
    ...
    <div class="main">
        ...
        <!--hero section start-->
        <section class="hero-equal-height ptb-120 gradient-overlay bg-image" image-overlay="7">
            <div class="background-image-wraper" style="background: url('assets/img/hero-section-domain-search.jpg')no-repeat center center / cover; opacity: 1;"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="hero-content-left text-white text-center">
                            <h1 class="text-white">Search for Find Unique Domains!</h1>
                            <p class="lead">Big discount! 25% Off on web hosting, Upto 30% on .com domain. Web hosting starting from $1.64/month, free SSL certificate , money back guarantee.</p>
    
                            <?php 
                                $from       = !empty($_GET['from']) ? $_GET['from'] : '';
                                $domain     = !empty($_GET['domain']) ? $_GET['domain'] : '';
                                $domainType = !empty($_GET['domainType']) ? $_GET['domainType'] : '';
                                $domainName = "";
                                ...
                                $domainInfo = $domainName ? dns_get_record($domainName) : [];
                            ?>
                            ...
                            <div class="domain-list-wrap text-center mt-4">
                                <ul class="list-inline domain-search-list">
                                    <li class="list-inline-item border rounded"><a href="#"><img src="assets/img/com-tld.png" alt="com" width="60" class="img-fluid"> <span>$8.99</span></a>
                                    </li>
                                    <li class="list-inline-item border rounded"><a href="#"><img src="assets/img/net-tld.png" alt="net" width="60" class="img-fluid"> <span>$15.5</span></a>
                                    </li>
                                    <li class="list-inline-item border rounded"><a href="#"><img src="assets/img/org-tld.png" alt="org" width="60" class="img-fluid"> <span>$15.94</span></a>
                                    </li>
                                    <li class="list-inline-item border rounded"><a href="#"><img src="assets/img/shop-tld.png" alt="shop" width="60" class="img-fluid"> <span>$33.98</span></a>
                                    </li>
                                    <li class="list-inline-item border rounded"><a href="#"><img src="assets/img/xyz-tld.png" alt="xyz" width="60" class="img-fluid"> <span>$1.76</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="content-with-sidebar">
                            ...
                            <table class="table vps-hosting-pricing-table domain-search-result-table alert-table mb-5">
                                ...
                                <tr class="vps-pricing-row">
                                    ...
                                    <td>
                                        <p>
                                            <span class="rate">$8.95<span>/year</span></span>
                                            <span class="pricing-onsale">On sale - <span class="badge color-3 color-3-bg">Save 30%</span></span>
                                        </p>
                                    </td>
                                    <td>
                                        <a href="https://clients.kloudwebs.com/cart.php?a=add&domain=register&query=<?php echo $domainName; ?>" class="btn btn-brand-01 btn-sm">Add to Cart</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table vps-hosting-pricing-table domain-search-result-table">
                                ...
                                <tr class="vps-pricing-row">
                                    ...
                                    <td data-value="Price">
                                        <p>
                                            <span class="rate">$15.50<span>/year</span></span>
                                ...
                                <tr class="vps-pricing-row">
                                    ...
                                    <td data-value="Price">
                                        <p>
                                            <span class="rate">$15.94<span>/year</span></span>
                                ...
                                <tr class="vps-pricing-row">
                                    ...
                                    <td data-value="Price">
                                        <p><span class="rate">$20.34<span>/month</span></span><span class="pricing-onsale">On sale - <span
                                ...
                                <tr class="vps-pricing-row">
                                    ...
                                    <td data-value="Price">
                                        <p><span class="rate">$56.64<span>/year</span></span><span class="pricing-onsale">On sale - <span
                                ...
                                <tr class="vps-pricing-row">
                                    ...
                                    <td data-value="Price">
                                        <p><span class="rate">$$36.295<span>/year</span></span><span class="pricing-onsale">On sale - <span
        ...
        <section class="feature-tab-section ptb-100 ">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-12 order-lg-last">
                        <div class="image-box fadein text-xl-right text-center">
                            <img src="assets/img/network-cable.jpg" alt="wp-hosting"
                ...
                <div class="row justify-content-between mt-5">
                    <div class="col-xl-6 col-lg-6 col-12 order-lg-last">
                        <div class="image-box fadein text-xl-right text-center">
                            <img src="assets/img/server-room.jpg" alt="wp-hosting" class="img-fluid rounded"/>
                        </div>
                    </div>
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-md-5 col-lg-4">
                        <div class="cta-img-wrap text-center">
                            <img src="assets/img/server-room.jpg" class="img-fluid" alt="server room">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading text-center mb-5">
                            ...
                            <p>We are being asked frequently with these queries from customer's perspective. Here are among some of them enlisted to enrich your knowledge. Still have questions? Contact Us</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="accordion" class="accordion faq-wrap">
                            <div class="card mb-3">
                                <a class="card-header " data-toggle="collapse" href="#collapse0" aria-expanded="false">
                                    <h6 class="mb-0 d-inline-block">What is domain name?</h6>
                                </a>
                                <div id="collapse0" class="collapse show" data-parent="#accordion" style="">
                                    <div class="card-body white-bg">
                                        <p>Domain name is the identity of your online presens.if you plan to start your website you have to consider two things. One is the name (Domain) another is the space (Hosting) to make your website live. </p>
                                    </div>
                                </div>
                            </div>
                            <div class="card my-3">
                                ...
                                <div id="collapse1" class="collapse " data-parent="#accordion" style="">
                                    <div class="card-body white-bg">
                                        <p>Web hosting are the space where your website hosted. If you plan to start your website you have to consider two things. One is the name (Domain) another is the space (Hosting) to make your website live. </p>
                                    </div>
                                </div>
                            </div>
                            <div class="card my-3">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapse2" aria-expanded="false">
                                    <h6 class="mb-0 d-inline-block">What Are the Different Types of Web Hosting Products Kloudwebs offers?</h6>
                                </a>
                                <div id="collapse2" class="collapse " data-parent="#accordion" style="">
                                    <div class="card-body white-bg">
                                        <p>Kloudwebs offers various types of web hosting for your business. We have shared hosting to make start your business smoothly with budget friendly. Our Cloud hosting gives your ultimate experience of using as well as we have business hosting to make your business more faster and more productive. </p>
                                    </div>
                                </div>
                            </div>
                            <div class="card mt-3">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapse3" aria-expanded="false">
                                    <h6 class="mb-0 d-inline-block">How Do I Buy a Domain Name?</h6>
                                </a>
                                <div id="collapse3" class="collapse " data-parent="#accordion" style="">
                                    <div class="card-body white-bg">
                                        <p>To buy a domain name simply type your desired name on our domain search panel and see whether it's available or not. If it's available then follow the on boarding instruction and finish the process to buy your domain. Remember buying a domain is like booking and it's solely yours for 1 year if you don't renew after 1 year. So, if you find available name buy immediately so that noboday can buy yours. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!--footer bottom copyright end--><!--footer section end-->
